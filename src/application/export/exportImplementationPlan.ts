...
export const exportImplementationPlan = (blueprint: ProjectBlueprint): string => {
  ...
  return `${joinBlocks([
    ...
    joinBlocks([
      ...
      plan.planSummary,
      "Agent Run Harness workflow: choose one task, generate an Agent Run Packet, copy it to your external execution tool, paste the result report back, and review coverage before accepting the run. Framework Architect does not execute or verify code directly.",
    ]),
